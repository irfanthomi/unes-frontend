                                ...
                                <tr key={index} title={item.judul} className="border-b border-gray-200 hover:bg-gray-100">
                                    ...
                                    <td className="py-3 px-6 text-left whitespace-nowrap">
                                        <div className="flex items-center">
                                            ...
                                            <span className="font-medium">{item.judul.substr(0, 50)} .... </span>
                                        </div>
                                    </td>
                                    <td className="py-3 px-6 text-left">
                                        <span className="bg-purple-200 text-purple-600 py-1 px-3 rounded-full text-xs">{item.kategori?.kategori}</span>
